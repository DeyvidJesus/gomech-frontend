...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  async function login(email: string, password: string) {
    try {
      ...
      const response = await fetch('https://clear-ellene-deyvidgondim-8b8a208e.koyeb.app/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  async function register(name: string, email: string, password: string) {
    try {
      ...
      const response = await fetch('https://clear-ellene-deyvidgondim-8b8a208e.koyeb.app/api/auth/register', {
        method: 'POST',
